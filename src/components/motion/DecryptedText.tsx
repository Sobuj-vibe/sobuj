...
/**
 * Reusable scramble / "decrypt" text reveal.
 * Drop it around any short string (titles work best) — see props below.
 */
export type DecryptedTextProps = {
  text: string;
  /** ms between scramble iterations */
  speed?: number;
  ...
  /** scramble only using characters already present in `text` */
...
} & Omit<ComponentPropsWithoutRef<typeof motion.span>, "children" | "className">;
